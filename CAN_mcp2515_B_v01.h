// #############################################################################
//
// Название     : CAN_mcp2515_B_v01.h, файл настроек библиотеки
...
//                Основной файл библиотеки CAN_mcp2515_B_v01.c
//
// Автор        : Змушко Е.С.
...
#define SPI_PORT_B	PORTB
#define SPI_TRIS_B	TRISB
...
#define CAN_SET_MOSI_B()	(SPI_PORT_B |= (1<<CAN_MOSI))
#define CAN_CLR_MOSI_B()	(SPI_PORT_B &= ~(1<<CAN_MOSI))
#define CAN_SET_SCL_B()	(SPI_PORT_B |= (1<<CAN_SCL))
#define CAN_CLR_SCL_B()	(SPI_PORT_B &= ~(1<<CAN_SCL))
#define CAN_SET_RST_B()	(SPI_PORT_B |= (1<<CAN_RST))
#define CAN_CLR_RST_B()	(SPI_PORT_B &= ~(1<<CAN_RST))
#define CAN_SET_CS_B()	(SPI_PORT_B |= (1<<CAN_CS))
#define CAN_CLR_CS_B()	(SPI_PORT_B &= ~(1<<CAN_CS))
#define CAN_TEST_MISO_B()	((SPI_PORT_B&(1<<CAN_MISO))!=0)
#define CAN_TEST_INT_B()	((SPI_PORT_B&(1<<CAN_INT))!=0)
#define CAN_SET_MISO_B()	(SPI_PORT_B |= (1<<CAN_MISO))
#define CAN_CLR_MISO_B()	(SPI_PORT_B &= ~(1<<CAN_MISO))
#define CAN_SET_INT_B()	(SPI_PORT_B |= (1<<CAN_INT))
#define CAN_CLR_INT_B()	(SPI_PORT_B &= ~(1<<CAN_INT))
