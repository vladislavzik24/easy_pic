// #############################################################################
//
// Название     : CAN_mcp2515_A_v01.h, файл настроек библиотеки
...
//                Основной файл библиотеки CAN_mcp2515_A_v01.c
//
// Автор        : Змушко Е.С.
...
#define SPI_PORT_A	PORTD
#define SPI_TRIS_A	TRISD
...
#define CAN_SET_MOSI_A()	(SPI_PORT_A |= (1<<CAN_MOSI))
#define CAN_CLR_MOSI_A()	(SPI_PORT_A &= ~(1<<CAN_MOSI))
#define CAN_SET_SCL_A()	(SPI_PORT_A |= (1<<CAN_SCL))
#define CAN_CLR_SCL_A()	(SPI_PORT_A &= ~(1<<CAN_SCL))
#define CAN_SET_RST_A()	(SPI_PORT_A |= (1<<CAN_RST))
#define CAN_CLR_RST_A()	(SPI_PORT_A &= ~(1<<CAN_RST))
#define CAN_SET_CS_A()	(SPI_PORT_A |= (1<<CAN_CS))
#define CAN_CLR_CS_A()	(SPI_PORT_A &= ~(1<<CAN_CS))
#define CAN_TEST_MISO_A()	((SPI_PORT_A&(1<<CAN_MISO))!=0)
#define CAN_TEST_INT_A()	((SPI_PORT_A&(1<<CAN_INT))!=0)
#define CAN_SET_MISO_A()	(SPI_PORT_A |= (1<<CAN_MISO))
#define CAN_CLR_MISO_A()	(SPI_PORT_A &= ~(1<<CAN_MISO))
#define CAN_SET_INT_A()	(SPI_PORT_A |= (1<<CAN_INT))
#define CAN_CLR_INT_A()	(SPI_PORT_A &= ~(1<<CAN_INT))
